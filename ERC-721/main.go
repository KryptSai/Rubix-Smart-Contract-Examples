...
func GenerateSmartContract() {
	...
	*/
	...
	wasmPath := "erc_contract/target/wasm32-unknown-unknown/debug/erc_contract.wasm"
	schemaPath := "/home/rubix/Sai-Rubix/ERC-721/erc-721/erc_contract/target/.rustc_info.json"
	rawCodePath := "./erc_contract/src/lib.rs"
	port := "20009"
...
func smartContractHash() string {
	return "Qmb93HawDW9FSVGeXfqmySiFH63LGsWnDoYNh1hXgQ5XNE"
}
